...
const chips = [
  '📍 Dhaka, BD','🎓 CSE @ DIU','💼 Open to Freelance',
  '🏴‍☠️ MERN Stack','🎨 UI/UX Design','🖥 VS Code',
]

export default function About() {
  return (
    <section id="about" className="relative bg-bg2 px-[5vw] py-24 overflow-hidden">
      <div className="absolute right-[-4rem] bottom-[-4rem] text-[20rem] opacity-[0.018] text-red pointer-events-none leading-none select-none">☠</div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-16 md:gap-20 items-center">
          ...
          <div data-aos="fade-up" data-aos-delay="200"
            ...
            {stats.map(s => (
              <div key={s.label}
                ...
                <div className="font-pixel text-[0.32rem] text-op-dim tracking-widest mt-1">{s.label}</div>
              </div>
            ))}
          </div>
        </div>
        ...
        <div data-aos="fade-left">
          <div className="bg-bg3 p-8 relative" style={{border:'1px solid var(--border)',borderLeft:'3px solid var(--red)'}}>
            <div className="absolute left-0 top-0 w-[3px] h-full pointer-events-none"
