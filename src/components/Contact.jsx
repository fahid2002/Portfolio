      ...
      <div className="grid grid-cols-1 md:grid-cols-[1fr_1.6fr] gap-12 md:gap-20 items-start">
        ...
        <div>
          {infoItems.map(({ Icon, label, value, href, cls }) => {
            ...
            return (
              <motion.div key={label} data-aos="fade-right"
                whileHover={href ? { x: 4 } : {}}
        ...
        {/* RIGHT form */}
        <form ref={formRef} onSubmit={onSubmit} className="flex flex-col gap-5" data-aos="fade-left">
          ...
          {status === 'sent' && (
            <motion.p initial={{opacity:0,y:8}} animate={{opacity:1,y:0}}
              className="font-pixel text-[0.38rem] tracking-widest" style={{color:'#44ff88'}}>
